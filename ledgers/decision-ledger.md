...
| D-011a | **Superseded 02:** optical support recomputed as the exact run-level union (133.112 h, not 197.075 h) | External review: the envelope figure was an upper bound presented as support. VLBI and GNSS legs remain upper bounds, so overlaps are still bounded | 02 |
